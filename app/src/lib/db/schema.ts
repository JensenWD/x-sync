...
export const bookmarks = sqliteTable(
  ...
  (t) => [
    index('bookmarks_archived_at_idx').on(t.archivedAt),
    index('bookmarks_bookmarked_at_idx').on(t.bookmarkedAt),
    index('bookmarks_like_count_idx').on(t.likeCount),
    index('bookmarks_author_handle_idx').on(t.authorHandle),
  ],
);
...
export const bookmarkTags = sqliteTable(
  ...
  (t) => [
    ...
    index('bookmark_tags_source_idx').on(t.source),
  ],
);
